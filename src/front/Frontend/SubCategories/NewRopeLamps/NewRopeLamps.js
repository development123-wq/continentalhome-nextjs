...
const NewRopeLamps = () => {
  ...
  useEffect(() => {
    fetch('https://187.124.157.146.nip.io/continental/api/products?search=&page=1&limit=500&categoryId=16&subcategoryId=4')
      .then((res) => res.json())
      .then((response) => {
    ...
    <div className="main-Shoppage">
      ...
      <div className="product-conatiner">
        <div className="row product_row">
          <h2>
            Shop By <span className="fancy-text">New Rope Lamps</span>
          </h2>
