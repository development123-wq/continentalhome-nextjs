...
const DriftwoodFloorLamps = () => {
  const [data, setData] = useState([]);
  const [currentPage, setCurrentPage] = useState(1);
  const productsPerPage = 12;

  useEffect(() => {
    fetch('https://187.124.157.146.nip.io/continental/api/products?search=&page=1&limit=500&categoryId=14&subcategoryId=21')
      .then((res) => res.json())
      .then((response) => {
    ...
    <div className="main-Shoppage">
      ...
      <div className="product-conatiner">
        <div className="row product_row">
          <h2>
            Shop By <span className="fancy-text">Driftwood Floor Lamps</span>
          </h2>
...
export default DriftwoodFloorLamps;
