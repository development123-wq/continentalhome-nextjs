        ...
        <div className="category-conatiner">
            <div className="row category_row">
                ...
                <div className="col-md-12 category-section" style={{gap:'40px'}}>
                    <a href="/mini-vertico-riverine-driftwood-table-lamp"><div className="category-define" style={{width:'100%'}}><Image src={cat2} alt="cate1"></Image><h4>Driftwood Lamps</h4></div></a>
                    <a href="/perifere-table-lamps"><div className="category-define" style={{width:'100%'}}><Image src={cat1} alt="cate2"></Image><h4>Table Lamps</h4></div></a>                  
                    ...
                    <a href="/sculpted-natural-vine-floor-lamp-fl601"><div className="category-define" style={{width:'100%'}}><Image src={cat4} alt="cate3"></Image><h4>Floor Lamps</h4></div></a>
                    <a href="/branches-table-lamp"><div className="category-define" style={{width:'100%'}}><Image src={cat5} alt="cate4"></Image><h4>Teak Lamps</h4></div></a>
                </div>
            </div>
