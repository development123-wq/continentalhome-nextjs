      ...
      subQuestions: [
        {
          ...
          answer: (
            <>
              Click the {accountLink} link at the top right hand side of our
              site to check your orders status.
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          answer: (
            <>
              Click the {accountLink} link at the top right hand side of our
              site to track your order status. Be sure that all of the items in
              your order have shipped already. If your order displays your
              Package Tracking Numbers, check with the shipper to confirm that
              your packages were delivered. If your packages each show a status
              of "delivered", please contact customer service for assistance.
            </>
          ),
        },
        {
      ...
      subQuestions: [
        {
          ...
          answer: (
            <>
              1) Click the {accountLink} link at the top right side of our
              site.{"\n"}
              2) Enter your email address.{"\n"}
              3) Select "I am a new customer".{"\n\n"}
              Then simply follow the prompts to complete setting up your
              account. Your information is NEVER sold to any other company and
              is kept completely private. Please view our Privacy Policy for
              more information.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              Click the {accountLink} link at the top right hand side of our
              site to edit your account information.
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          answer: (
            <>
              Click the {accountLink} link at the top right hand side of our
              site. Under the login box you'll see a link that says "Forgot your
              password? Click here". That link will send an email to you with
              your password.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              ...
              for more information on returning an item.
            </>
          ),
        },
        {
      ...
      subQuestions: [
        {
          ...
          answer: (
            <>
              Please create an account by clicking the {accountLink} link at the
              top right hand side of our site. During signup we'll ask for your
              shipping address details including country. If your country is not
              in the dropdown menu of available countries, unfortunately we
              cannot ship to your country at this time.
            </>
          ),
        },
        {
      ...
      subQuestions: [
        {
          ...
          answer: (
            <>
              Click the {accountLink} link at the top right hand side of our
              site to review your orders. You may compare your order history on
              our website, with your financial records. If you have further
              questions or concerns, please contact customer service for further
              assistance.
            </>
          ),
        },
            ...
            {activeMainIndex === mainIndex && (
              ...
              >
                {faq.subQuestions.map((subQuestion, subIndex) => {
                  const isObject =
                    typeof subQuestion === "object" && subQuestion.question;
                        ...
                        style={{
                          ...
                          backgroundColor:
                            activeSubIndex === subIndex
                              ...
                              : "transparent",
                          color:
                            activeSubIndex === subIndex ? "#fff" : "#555",
                          borderRadius: "8px",
                          transition: "all 0.3s ease",
                        }}
                      >
                        <span style={{ flex: 1 }}>
                          {isObject ? subQuestion.question : subQuestion}
                        </span>
