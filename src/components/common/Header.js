        ...
        <div className="container-xxl">
          <div className="h-right d-flex align-items-center order-1">
              ...
              <Dropdown.Menu className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-5 ">
                <div className="card border-0">
                  <ul className="list-unstyled list py-2 px-3">
                    <li><Dropdown.Item href="#!"><Image src={GB} alt="" /> English</Dropdown.Item></li>
                    <li><Dropdown.Item href="#!"><Image src={DE} alt="" /> German</Dropdown.Item></li>
                    <li><Dropdown.Item href="#!"><Image src={FR} alt="" /> French</Dropdown.Item></li>
                    <li><Dropdown.Item href="#!"><Image src={IT} alt="" /> Italian</Dropdown.Item></li>
                    <li><Dropdown.Item href="#!"><Image src={RU} alt="" /> Russian</Dropdown.Item></li>
                  </ul>
                </div>
              </Dropdown.Menu>
            </Dropdown> */}
                      ...
                      <li className="py-2 mb-1 border-bottom">
                        <a href="#!" className="d-flex">
                          ...
                          <div className="flex-fill ms-2">
                            ...
                            <span>Added a task <span className="badge bg-success">Review</span></span>
                          </div>
                        </a>
                      </li>
              ...
              <Dropdown.Menu className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0 mt-5 ">
                <div className="card border-0 w280">
                  ...
                  <div className="list-group m-2">
                    <Link to="/profile-pages" className="list-group-item list-group-item-action border-0">
                      <i className="icofont-ui-user fs-5 me-3"></i>Profile Page
                    </Link>
                    <button onClick={handleLogout} className="list-group-item list-group-item-action border-0">
            ...
            <div className="setting ms-2">
              <a href="#!" onClick={() => props.Onopenmodalsetting(true)}>
